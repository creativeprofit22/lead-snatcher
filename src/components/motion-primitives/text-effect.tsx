...
const isVariantObject = (variant?: Variant): variant is TargetAndTransition => {
...
const hasTransition = (
  ...
  return isVariantObject(variant) && 'transition' in variant;
};
...
const createVariantsWithTransition = (
  ...
  const exitVariant = baseVariants.exit;

  return {
    ...baseVariants,
    visible: {
      ...(isVariantObject(visibleVariant) ? visibleVariant : {}),
      transition: {
        ...(hasTransition(visibleVariant) ? visibleVariant.transition : {}),
        ...mainTransition,
      },
    },
    exit: {
      ...(isVariantObject(exitVariant) ? exitVariant : {}),
      transition: {
        ...(hasTransition(exitVariant) ? exitVariant.transition : {}),
        ...mainTransition,
        staggerDirection: -1,
      },
    },
